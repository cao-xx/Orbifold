/*  Taken from the new Example Framework.
 *
 *
 *
 *
...
namespace Orbifold {
    ...
    public:
		...
		virtual void buttonHit(SdkButton* button) {}
	...
	| Basic button class.
	=============================================================================*/
	class SdkButton : public Widget
	{
	public:

		// Do not instantiate any widgets directly. Use SdkTrayManager.
		SdkButton(const Ogre::String& name, const Ogre::DisplayString& caption, Ogre::Real width)
		{
	...
	public:
		...
		void docheck(bool notifyListener = true) {
    ...
    public:
		...
		SdkButton* createButton(TrayLocation trayLoc, const Ogre::String& name, const Ogre::String& caption, Ogre::Real width = 0)
		{
			SdkButton* b = new SdkButton(name, caption, width);
		...
		void showOkDialog(const Ogre::DisplayString& caption, const Ogre::DisplayString& message)
		{
			...
			mOk = new SdkButton(mName + "/OkButton", "OK", 60);
		...
		void showYesNoDialog(const Ogre::DisplayString& caption, const Ogre::DisplayString& question)
		{
			...
			mYes = new SdkButton(mName + "/YesButton", "Yes", 58);
			...
			mNo = new SdkButton(mName + "/NoButton", "No", 50);
		...
		-----------------------------------------------------------------------------*/
		void buttonHit(SdkButton* button)
		{
			if (button == mOk)
			{
    ...
    protected:
		...
		SdkButton* mOk;                          // top priority OK button
		SdkButton* mYes;                         // top priority Yes button
		SdkButton* mNo;                          // top priority No button
